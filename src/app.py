...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for interscholastic soccer matches and develop team skills",
        "schedule": "Mondays, Wednesdays, Saturdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["lily@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming techniques and compete in relay events",
    ...
    "Science Quiz Bowl": {
        "description": "Study science topics and compete in academic quiz tournaments",
